  ...
  replaceInFile(
    ...
    [
      [
        ...
        "export TARGETS=\"webrtc libjingle_peerconnection libc++ libc++abi rtc_media_engine_defaults builtin_video_encoder_factory builtin_video_decoder_factory rtc_internal_video_codecs\"",
      ],
    ],
  );
