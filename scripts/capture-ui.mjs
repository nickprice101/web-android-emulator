...
<svg width="1440" height="900" viewBox="0 0 1440 900" fill="none" xmlns="http://www.w3.org/2000/svg">
  ...
  <text x="852" y="34" text-anchor="middle" fill="#D7DFED" font-family="Segoe UI, Arial, sans-serif" font-size="13">target 24fps</text>
  ...
  <text x="58" y="626" fill="#9DB0CC" font-family="Segoe UI, Arial, sans-serif" font-size="12">The server stays close to adb</text>
  <text x="58" y="644" fill="#9DB0CC" font-family="Segoe UI, Arial, sans-serif" font-size="12">and scrcpy, like Guacamole.</text>
  ...
  <text x="300" y="610" fill="#D7DFED" font-family="Segoe UI, Arial, sans-serif" font-size="12">target: 24fps</text>
  <text x="300" y="628" fill="#D7DFED" font-family="Segoe UI, Arial, sans-serif" font-size="12">bitrate: 6 Mbps</text>
  <text x="300" y="648" fill="#D7DFED" font-family="Segoe UI, Arial, sans-serif" font-size="12">input: HTTP API</text>
  <text x="300" y="668" fill="#D7DFED" font-family="Segoe UI, Arial, sans-serif" font-size="12">fallback: PNG preview</text>
  ...
  <text x="578" y="390" fill="#D7DFED" font-family="Consolas, monospace" font-size="13">Streaming scrcpy fragmented MP4 at a 24fps target.</text>
  ...
  <text x="578" y="536" fill="#A8B3C7" font-family="Segoe UI, Arial, sans-serif" font-size="13">Video frame: Guacamole-style scrcpy MP4 over ordinary HTTPS fetch (24fps target)</text>
  <text x="578" y="562" fill="#A8B3C7" font-family="Segoe UI, Arial, sans-serif" font-size="13">HTTP tunneling stays front and center for corporate-firewall-friendly emulator access.</text>
  <rect x="560" y="616" width="842" height="212" rx="12" fill="#111823" stroke="#2B313D"/>
  <text x="578" y="642" fill="#A8B3C7" font-family="Segoe UI, Arial, sans-serif" font-size="13">Scrcpy HTTP video diagnostics</text>
  ...
  <text x="578" y="708" fill="#D7DFED" font-family="Consolas, monospace" font-size="12">video: ready 4, net 2, 1080x1920 | buffered: live</text>
  <text x="578" y="728" fill="#D7DFED" font-family="Consolas, monospace" font-size="12">input path: keyboard, mouse, and touch events are posted through /api/input-event</text>
  <defs>
