...
assert.match(composeConfig, /EMULATOR_SYSTEM_IMAGE:\s*"\$\{EMULATOR_SYSTEM_IMAGE:-system-images;android-35;google_apis;arm64-v8a\}"/, "compose must default to the API 35 Google APIs arm64-v8a system image");
assert.match(composeConfig, /EMULATOR_PLATFORM:\s*"\$\{EMULATOR_PLATFORM:-platforms;android-35\}"/, "compose must default to the Android 35 platform package");
...
assert.match(emulatorDockerfile, /ARG EMULATOR_SYSTEM_IMAGE=system-images;android-35;google_apis;arm64-v8a/, "emulator Dockerfile must default to the API 35 Google APIs arm64-v8a system image");
assert.match(emulatorDockerfile, /ARG EMULATOR_PLATFORM=platforms;android-35/, "emulator Dockerfile must default to the Android 35 platform package");
...
assert.match(emulatorWrapper, /EMULATOR_SYSTEM_IMAGE="\$\{EMULATOR_SYSTEM_IMAGE:-system-images;android-35;google_apis;arm64-v8a\}"/, "emulator wrapper must default to the API 35 Google APIs arm64-v8a system image");
assert.match(emulatorWrapper, /EMULATOR_PLATFORM="\$\{EMULATOR_PLATFORM:-platforms;android-35\}"/, "emulator wrapper must default to the Android 35 platform package");
